...
class checkout(View):
    def get(self, request):
        ...
        #{'id': 'order_Lp64juxIVe2ccb', 'entity': 'order', 'amount': 124000, 'amount_paid': 0, 'amount_due': 124000, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1683969961}
